...
// JASafeCast
#define COCOAPODS_POD_AVAILABLE_JASafeCast
#define COCOAPODS_VERSION_MAJOR_JASafeCast 0
#define COCOAPODS_VERSION_MINOR_JASafeCast 1
#define COCOAPODS_VERSION_PATCH_JASafeCast 0
